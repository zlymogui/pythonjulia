...
def DiscountCouponValidation(billamount,coupon,card_number,mobile):
    # 接口的url
...
if __name__ == "__main__":
    DiscountCouponValidation('1000', 'MSDUKJ2P','','18221426687')
    DiscountCouponValidation('1000', '9IJ2Y6DE','','18221426687')
    DiscountCouponValidation('1000', 'MSDUKJ2P','','18221426686')
    DiscountCouponValidation('1000', 'MSDUKJ2P','','')
