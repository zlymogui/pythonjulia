...
def CouponValidation4kinds(billamount,coupon,card_number,mobile):
    # 接口的url
    url = "http://adapterconfig.capillarytech.cn.com/api/descente/validatecoupon"
    ...
    if resp["response"]["status"]=="1000":
        ...
        print(resp["response"]["coupon_type"])
    elif resp["response"]["status"]=="500":
        print(resp["response"]["message"])
    else: print(resp)

if __name__ == "__main__":
    CouponValidation4kinds('1000', 'MSDUKJ2P','','18221426687')
    CouponValidation4kinds('1000', '9IJ2Y6DE','','18221426687')
    CouponValidation4kinds('1000', 'MSDUKJ2P','','18221426686')
    CouponValidation4kinds('1000', 'MSDUKJ2P','','')
